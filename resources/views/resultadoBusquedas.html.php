                    ...
                    <div class="switch-right-grid">
                        <div class="container-fluid" style="padding-top:15px;">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-3">
                                    <h3><label class="label label-success"><?php echo codificarCaracteres($cliente['obligaciones'][0]['estado_obligacion']) ?></label></h3>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-xs-3">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <select class="form-control" id="accionGestion" name="accionGestion" required>
                                        <option value="">..seleccione..</option>
                                        <?php foreach ($gestion['acciones'] as $accion) : ?>
                                            <option value="<?php echo $accion['id'] ?>"><?php echo strtoupper(codificarCaracteres($accion['homologado'])); ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                </div>
                            </div>
