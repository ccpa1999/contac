    ...
    <div class="col-sm-12 col-md-12">
        <div class="thumbnail">
            <form id="formParametroArbol" action="javascript:void(0);">
                ...
                ?>
                    <?php if ($i % 6 == 0) {?> <div class="row" style="margin-bottom: 20px;"> <?php } ?>
                        ...
                        <!-- <div class="caption" style="text-align: center;"> -->
                            ...
                            <div class="col-sm-2 border border-primary h-100 d-inline-block" style="border-left: 1px solid #D1CCDC;">
                                <input type="checkbox" <?php echo $propiedad; ?> name="parametro[]" value="<?php echo $homologado['id'] . '-' . $parametro_id; ?>">

                                <?php echo (isset($homologado['homologado'])) ? mb_strtoupper(codificarCaracteres($homologado['homologado'])) : ''; ?>
                                <?php echo (isset($homologado['motivo'])) ? mb_strtoupper(codificarCaracteres($homologado['motivo'])) : ''; ?>
                            </div>
                ...
                <div class="row" style="text-align: center; padding: 20px;">
                    <div class="col-sm-12 col-md-12">
                        ...
                        <input type="hidden" name="contacto" value="<?php echo $parametro_id; ?>">
