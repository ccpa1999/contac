<ol class="breadcrumb">
    <li><a href="./carterasController.php?cartera=<?php echo $cartera ?>">FIANZA LTDA</a></li>
    <li>Campañas</li>
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <select class="form-control" required name="id_accion">
                                                                ...
                                                                <?php foreach ($datos['accion'] as $accion) : ?>
                                                                    <option value="<?php echo $accion['id']; ?>"><?php echo mb_strtoupper(codificarCaracteres(($accion['accion']))); ?></option>
                                                                <?php endforeach; ?>
                                                            </select>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <table class="table table-bordered" style="text-align: center;">
                                                        <thead>
                                                            <tr class="active text-center">
                                                                <th class="text-center"><span class="fa fa-volume-control-phone success"></span> ACCIÓN </th>
                                                        ...
                                                        <tbody>
                                                            <?php foreach ($datos['homologado_accion'] as $homologado) : ?>
                                                                <tr>
                                                                    <td><?php echo mb_strtoupper(codificarCaracteres($homologado['homologado'])) ?></td>
                                                                    <td>
                                                                        <div class="btn-group" role="group" aria-label="...">
                                                                            ...
                                                                            <a class="btn btn-danger eliminarRegistro" data-toggle="modal" data-target="#myModal" data-metodo="eliminarRegistro" data-accion="borrarAccion" data-id="<?php echo $homologado['id'] ?>" href="#" role="button">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <select class="form-control" required name="id_contacto">
                                                                ...
                                                                <?php foreach ($datos['contacto'] as $contacto) : ?>
                                                                    <option value="<?php echo $contacto['id']; ?>"><?php echo mb_strtoupper(codificarCaracteres($contacto['contacto'])); ?></option>
                                                                <?php endforeach; ?>
                                                            </select>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="row">
                                                <div class="table-responsive">
                                                    <table class="table table-bordered" style="text-align: center;">
                                                        <thead>
                                                            <tr class="active">
                                                                <th class="text-center"><span class="fa fa-user-circle success"></span> CONTACTO</th>
                                                                <th class="text-center">ACCIONES</th>
                                                            </tr>
                                                        </thead>
                                                        <tbody>
                                                                    ...
                                                                    <td>
                                                                        <div class="btn-group" role="group" aria-label="...">
                                                                            <a class="btn btn-primary formularioEditarRegistro" data-toggle="modal" data-target="#editarRegistro" data-accion="EditarRegistro" data-tipo="EditarContacto" data-id="<?php echo $homologado['id'] ?>" href="#" role="button">
                                                                                <span class="glyphicon glyphicon-edit"></span> </a>
                                                                            <a class="btn btn-danger eliminarRegistro" data-toggle="modal" data-metodo="eliminarRegistro" data-target="#myModal" data-controlador="administracionController" data-accion="borrarContacto" data-id="<?php echo $homologado['id'] ?>" href="#" role="button">
                                                                                <span class="glyphicon glyphicon-remove"></span></a>
                                                                        </div>
                                                                    </td>
                                                                </tr>
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <select class="form-control" required name="id_efecto">
                                                                ...
                                                                <?php foreach ($datos['efecto'] as $efecto) : ?>
                                                                    <option value="<?php echo $efecto['id']; ?>"><?php echo mb_strtoupper(codificarCaracteres($efecto['efecto'])) ?></option>
                                                                <?php endforeach; ?>
                                                            </select>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="row">
                                                <div class="table-responsive">
                                                    <table id="acciones" class="table table-bordered" style="text-align:center;">
                                                        <thead>
                                                            <tr class="active">
                                                                <th class="text-center"><span class="fa fa-flash success"></span> EFECTO</th>
                                                                <th class="text-center">ACCIONES</th>
                                                            </tr>
                                                        </thead>
                                                        <tbody>
                                                                    ...
                                                                    <td>
                                                                        <div class="btn-group" role="group" aria-label="...">
                                                                            <a class="btn btn-primary formularioEditarRegistro" data-toggle="modal" data-target="#editarRegistro" data-tipo="EditarEfecto" data-id="<?php echo $homologado['id'] ?>" href="#" role="button">
                                                                                <span class="glyphicon glyphicon-edit"></span> </a>
                                                                            <a class="btn btn-danger eliminarRegistro" data-toggle="modal" data-metodo="eliminarRegistro" data-target="#myModal" data-controlador="administracionController" data-accion="borrarEfecto" data-id="<?php echo $homologado['id'] ?>" href="#" role="button">
                                                                                <span class="glyphicon glyphicon-remove"></span></a>
                                                                        </div>
                                                                    </td>
                                                                </tr>
                                            ...
                                            <div class="row">
                                                <div class="table-responsive">
                                                    <table class="table table-bordered" style="text-align: center;">
                                                        <thead>
                                                            <tr class="active">
                                                                <th class="text-center"><span class="fa fa-money success"></span> MOTIVO NO PAGO</th>
                                                                <th class="text-center">ACCIONES</th>
                                                            </tr>
                                                        </thead>
                                                        <tbody>
                                                            <?php foreach ($datos['motivos_no_pago'] as $homologado) : ?>
                                                                <tr>
                                                                    <td><?php echo mb_strtoupper(codificarCaracteres($homologado['motivo'])) ?></td>
                                                                    <td>
                                                                        <div class="btn-group" role="group" aria-label="...">
                                                                            <a class="btn btn-primary formularioEditarRegistro" data-toggle="modal" data-target="#editarRegistro" data-tipo="EditarMotivo" data-id="<?php echo $homologado['id'] ?>" href="#" role="button">
                                                                                <span class="glyphicon glyphicon-edit"></span> </a>
                                                                            <a class="btn btn-danger eliminarRegistro" data-toggle="modal" data-metodo="eliminarRegistro" data-target="#myModal" data-controlador="administracionController" data-accion="borrarMotivo" data-id="<?php echo $homologado['id'] ?>" href="#" role="button">
                                                                                <span class="glyphicon glyphicon-remove"></span></a>
                                                                        </div>
                                                                    </td>
                                                                </tr>
                                        ...
                                        <div class="row">
                                            <div class="col-md-4 col-md-offset-2">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <select class="form-control" id="tipo_efecto" name="tipo_efecto" required>
                                                            <option value="">..Seleccione..</option>
                                                            <?php foreach ($datos['homologado_efecto'] as $homologado) : ?>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        <textarea name="txtGuion" id="txtGuion" class="form-control" placeholder="Texto que complementará la observación de la gestión"></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="thumbnail">
                                                ...
                                                <div class="caption" style="text-align: center;">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <select id="tipo_accion" name="tipo_accion" required="" class="form-control">
                                                                <option value="">..Seleccione..</option>
                                            ...
                                            <div class="thumbnail">
                                                ...
                                                <div class="caption" style="text-align: center;">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <select class="form-control" id="tipoefecto" name="tipo_efecto" required="">
                                                                <option value="">..Seleccione..</option>
                                                            </select>
                                                        </div>
                                                    </div>
