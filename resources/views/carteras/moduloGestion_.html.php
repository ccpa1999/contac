                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                            <?php foreach ($cliente['obligaciones'] as $obligacion): ?>
                                                <tr class="refereciaObligacionGestion
" data-obligacion="<?php echo $obligacion['numero_obligacion']; ?>" style="cursor:pointer;">
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <div id="myTabContent" class="tab-content">
                                                        <div id="telefonos" class="tab-pane fade in active" role="tabpanel" aria-labelledby="home-tab">
                                                            <button class="btn btn-success btnFormularioCreacionDemografico" data-parametro="telefono" data-div="divTelefonos" data-formulario="formCreacionTelefono"
                                                        ...
                                                        <div id="direcciones" class="tab-pane fade" role="tabpanel" aria-labelledby="profile-tab">
                                                            <div id="direcciones2" class="tab-pane fade in active" role="tabpanel" aria-labelledby="home-tab">
                                                                <button class="btn btn-success btnFormularioCreacionDemografico" data-div="divDirecciones" data-parametro="direccion" data-formulario="formCreacionDireccion"
                                                                        data-identificacion="<?php echo $cliente['cliente'][0]['cedula'] ?>"><i class="fa fa-plus"></i> Agregar Dirección</button>
                                                                <hr>
                                                        ...
                                                        <div id="emails" class="tab-pane fade" role="tabpanel" aria-labelledby="profile-tab">
                                                            <div id="emails2" class="tab-pane fade in active" role="tabpanel" aria-labelledby="home-tab">
                                                                <button class="btn btn-success btnFormularioCreacionDemografico" data-div="divCorreos" data-parametro="email" data-formulario="formCreacionEmail"
                                                                        data-identificacion="<?php echo $cliente['cliente'][0]['cedula'] ?>"><i class="fa fa-plus"></i> Agregar E-mail</button>
                                                                <hr>
                                                                <div id="divCorreos">
                                                                    <table class="table table-striped table-responsive tableDemografico">
                                                                        <thead>
                                ...
                                <div class="btn-toolbar" role="toolbar">
                                    <div class="btn-group" role="group" >
                                        ...
                                        ?>
                                            ...
                                            <button type="button" class="btn btn-danger  accionExportarSolicitud" style="border: 1px solid #FFFFFF !important; border-radius: 6px;" id="btnSolicitudReestructuracion">
                                                <i class="fa fa-file-pdf-o "></i>
                                            </button>
                                            <button type="button" class="btn btn-primary  accionOpcionSimuladores" style="border: 1px solid #FFFFFF !important; border-radius: 6px;" id="btnSolicitudReestructuracion">
