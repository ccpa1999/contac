<?php
    $this->layout('layout.html', [
        ...
        'logoCarteraActual' => (isset($cartera[0]['ruta_logo'])) ? $cartera[0]['ruta_logo'] : '', 
        'cliente' => (isset($cliente['cliente'][0])) ? $cliente['cliente'][0] : ''
    ]);
?>
        ...
        <div class="col-md-12 switch">
            <div class="switch-right-grid">
                <div class="container-fluid" style="padding-top: 7px;">
                    <div class="row">
                        <div class="col-xs-2 cedulaGestion" id="cedulaGestion" data-clipboard-text="<?php echo (isset($cliente['cliente'][0]['cedula'])) ? $cliente['cliente'][0]['cedula'] : ''; ?>" title="Cedúla del cliente">
                            <a href="#">
                                <h4><i class="fa fa-user success"></i> <?php echo (isset($cliente['cliente'][0]['cedula'])) ? $cliente['cliente'][0]['cedula'] : ''; ?></h4>
                            </a>
                        </div>
                        <div class="col-xs-5">
                            <a href="#">
                                <h4><?php echo (isset($cliente['cliente'][0]['nombre'])) ? $cliente['cliente'][0]['nombre'] : ''; ?></h4>
                            </a>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="row">
                                <div class="col-xs-2">
                                    <a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapsCreditos" aria-expanded="true" aria-controls="collapsCreditos" title="Creditos del cliente">
                                        <h4><span class="fa fa-credit-card-alt success"></span> CRÉDITOS</h4>
                                    </a>
                                </div>
                                <div class="col-xs-5">
                                    <a href="#"><i class="fa fa-hand-o-left fa-2x"></i> <i>"Haga clic en 'CRÉDITOS' para desplegar la información de créditos"</i></a>
                                </div>
                            </div>
                        ...
                        <div class="panel-group container-fluid" id="accordion" role="tablist" aria-multiselectable="true">
                            <div class="panel panel-default">
                                <div class="row">
                                    ...
                                    <div class="col-xs-7">
                                        <a href="#"><i class="fa fa-hand-o-left fa-2x"></i> <i>"Haga clic en 'DEMOGRÁFICOS' para desplegar la información demográfica"</i></a>
                                    </div>
                                </div>
                                <div class="row">
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <div id="myTabContent" class="tab-content">
                                                        <div id="telefonos" class="tab-pane fade in active" role="tabpanel" aria-labelledby="home-tab">
                                                            <button class="btn btn-success btnFormularioCreacionDemografico" data-parametro="telefono" data-div="divTelefonos" data-formulario="formCreacionTelefono" data-identificacion="<?php echo (isset($cliente['cliente'][0]['cedula'])) ? $cliente['cliente'][0]['cedula'] : '' ?>"><i class="fa fa-plus"></i> Agregar Teléfono</button>
                                                            <hr>
                                                            <div id="divTelefonos">
                                                                    ...
                                                                    <tbody>
                                                                        ...
                                                                        ?>
                                                                            <tr style="height:30px; cursor:pointer;" class="telefonoGestion" data-telefono="<?php echo $telefono['telefono']; ?>">
                                                                                ...
                                                                                <td><?php echo ucwords(codificarCaracteres($telefono['tipo_telefono'])); ?></td>
                                                        ...
                                                        <div id="direcciones" class="tab-pane fade" role="tabpanel" aria-labelledby="profile-tab">
                                                            <div id="direcciones2" class="tab-pane fade in active" role="tabpanel" aria-labelledby="home-tab">
                                                                <button class="btn btn-success btnFormularioCreacionDemografico" data-div="divDirecciones" data-parametro="direccion" data-formulario="formCreacionDireccion" data-identificacion="<?php echo (isset($cliente['cliente'][0]['cedula'])) ? $cliente['cliente'][0]['cedula'] : '' ?>"><i class="fa fa-plus"></i> Agregar Dirección</button>
                                                                <hr>
                                                                        ...
                                                                        <tbody>
                                                                            ...
                                                                            ?>
                                                                                <tr style="height:30px;">
                                                                                    <td><?php echo ucwords(codificarCaracteres($direccion['ciudad'])); ?></td>
                                                                                    <td><?php echo ucwords(codificarCaracteres($direccion['direccion'])); ?></td>
                                                                                    <td><?php echo ucwords(codificarCaracteres($direccion['tipo_direccion'])); ?></td>
                                                                                    <td><label class="label label-<?php echo $clase; ?>"><?php echo $estado; ?></td>
                                                                                    <td style="text-align: center">
                                                                                        <div class="btn-group" role="group" aria-label="...">
                                                        ...
                                                        <div id="emails" class="tab-pane fade" role="tabpanel" aria-labelledby="profile-tab">
                                                            <div id="emails2" class="tab-pane fade in active" role="tabpanel" aria-labelledby="home-tab">
                                                                <button class="btn btn-success btnFormularioCreacionDemografico" data-div="divCorreos" data-parametro="email" data-formulario="formCreacionEmail" data-identificacion="<?php echo (isset($cliente['cliente'][0]['cedula'])) ? $cliente['cliente'][0]['cedula'] : '' ?>"><i class="fa fa-plus"></i> Agregar E-mail</button>
                                                                <hr>
                                                                <div id="divCorreos">
                                                                    <table class="table table-striped table-responsive tableDemografico">
                                                                        <thead>
                ...
                <div class="switch-right-grid">
                    <div class="container-fluid" style="padding-top:15px;">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-3">
                                <label class="label label-success"><?php echo ((isset($cliente['obligaciones'][0]['ultimo_efecto'])) ? $cliente['obligaciones'][0]['ultimo_efecto'] : '') ?></label>
                            </div>
                            <div class="col-xs-3">
                                <a href="#">
                            ...
                            <div class="col-xs-3">
                                <h3><label class="label label-success"><?php echo utf8_decode((isset($cliente['obligaciones'][0]['estado_obligacion'])) ? $cliente['obligaciones'][0]['estado_obligacion'] : '') ; ?></label></h3>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-xs-3">
                            ...
                            <div class="col-xs-3">
                                <label class="label label-success"><?php echo (isset($cliente['obligaciones'][0]['regional'])) ? $cliente['obligaciones'][0]['regional'] : '' ?></label>
                            </div>
                            <div class="col-xs-3">
                                <a href="#">
                            ...
                            <div class="col-xs-3">
                                <label class="label label-success"><?php echo (isset($cliente['obligaciones'][0]['estrategia_actual'])) ? $cliente['obligaciones'][0]['estrategia_actual'] : '' ?></label>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-xs-3">
                            ...
                            <div class="col-xs-3">
                                <label class="label label-success"><?php echo (isset($cliente['obligaciones'][0]['obligaciones'])) ? $cliente['obligaciones'][0]['obligaciones'] : '' ?></label>
                            </div>
                            <div class="col-xs-3">
                                <a href="#">
                            ...
                            <div class="col-xs-3">
                                <label class="label label-success"><?php echo (isset($cliente['obligaciones'][0]['saldo_expuesto'])) ? $cliente['obligaciones'][0]['saldo_expuesto'] : '' ?></label>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-xs-3">
                            ...
                            <div class="col-xs-3">
                                <label class="label label-success"><?php echo (isset($cliente['obligaciones'][0]['nueva_marca_foco'])) ? $cliente['obligaciones'][0]['nueva_marca_foco'] : '' ?></label>
                            </div>
                            <div class="col-xs-3">
                                <a href="#">
                                    <h4>Mono Multi</h4>
                            ...
                            <div class="col-xs-3">
                                <label class="label label-success"><?php echo (isset($cliente['obligaciones'][0]['mono_multi'])) ? $cliente['obligaciones'][0]['mono_multi'] : '' ?></label>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-xs-5 col-xs-offset-5">
                            <a href="#" title="Cedúla del cliente">
                                <h4><i class="fa fa-clock-o success"></i> HISTORIAL DE GESTIONES</h4>
                            </a>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-12 col-sm-12 col-lg-12">
                            <div id="divHistoricoGestion">
                                <table class="table table-bordered tablaHistoricoGestion" style="width: 100%;">
                                    ...
                                    <tbody>
                                        <?php if (gettype($historial) == 'array' && count($historial) >= 1) { ?>
                                            <?php foreach ($historial as $historico) : ?>
                                                <tr>
                                                    ...
                                                    <td><?php echo codificarCaracteres($historico['contacto']); ?></td>
                                                    ...
                                                    <td><?php echo codificarCaracteres($historico['observaciones']); ?></td>
                                                </tr>
                                            <?php endforeach; ?>
                                        <?php } ?>
                                    </tbody>
        ...
        <div id="sidebar-wrapper" class="ventanaMovimiento" style="z-index: 1000;">
            <div class="container-fluid" style="padding-top: 10px;">
                ...
                <form id="formularioGestion" action="javascript:void(0);">
                    <div class="row">
                        <div class="col-xs-12">
                                ...
                                <div class="input-group">
                                    ...
                                    <select class="form-control" id="accionGestion" name="accionGestion" required>
                                        ...
                                        <?php foreach ($gestion['acciones'] as $accion) : ?>
                                            <option value="<?php echo $accion['id'] ?>"><?php echo mb_strtoupper(codificarCaracteres($accion['homologado'])); ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div id="divEfectoGestion" style="display:none;">
                                ...
                                <div class="form-group">
                                    <label for="exampleInputEmail1"><strong>Actividad Económica</strong></label>
                                    <div class="input-group">
                                        <div class="input-group-addon"><i class="fa fa-exclamation"></i></div>
                            ...
                            <?php if ($carteraActual == 9) : ?>
                                <div class="form-group">
                                    <div class="alert alert-info">
                                        ...
                                        <input required type="radio" id="si" name="moto" value="SI">
                                        <label for="SI">SI</label><br>
                                        <input type="radio" id="no" name="moto" value="NO">
                    ...
                    <div class="row">
                        <div class="col-xs-2 col-xs-offset-9">
                            <div class="btn-group" role="group" aria-label="...">
                                ...
                                <button id="guardarGestion" type="submit" class="btn btn-success btn-lg" title="Guardar Gestión"><i class="fa fa-save"></i></button>
                            </div>
                        </div>
                    </div>
                    ...
                    <input type="hidden" name="cedula_deudor" id="cedula_deudor" value="<?php echo (isset($cliente['cliente'][0]['cedula'])) ? $cliente['cliente'][0]['cedula'] : '' ?>">
