...
$this->layout('layout.html', [
    ...
    'logoCarteraActual' => (isset($cartera[0]['ruta_logo'])) ? $cartera[0]['ruta_logo'] : '', 'cliente' => (isset($cliente['cliente'][0])) ? $cliente['cliente'][0] : ''
]);
?>
                ...
                <div class="switch-right-grid">
                    <div class="container-fluid" style="padding-top:15px;">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-3">
                                <h3><label class="label label-success"><?php echo (isset($cliente['obligaciones'][0]['estado_obligacion'])) ? $cliente['obligaciones'][0]['estado_obligacion'] : '' ?></label></h3>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-xs-3">
