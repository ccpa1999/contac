            ...
            <div class="btn-group btn-group-justified" role="group" aria-label="...">
                <?php foreach ($datos as $obligacion) : ?>
                    <div class="btn-group" role="group">
                        <button type="button" class="btn btn-default accionSeleccionObligacionSimulador" data-seleccionado="false" data-obligacion="<?php echo preg_replace("/[^0-9]/", "", $obligacion['saldo_total']); ?>">
                            <i class="fa fa-plus-square" /> <?php echo $obligacion['numero_obligacion']; ?>
                        </button>
                    </div>
                <?php endforeach; ?>
            </div>
        ...
        <div class="form-group col-xs-4">
            ...
            <div class="input-group">
                ...
                <select class="form-control" id="obligacion_simulador_consumo">
                    <option value="">..Seleccione..</option>
                    <?php foreach ($datos as $obligacion) : ?>
                        <option value="<?php echo preg_replace("/[^0-9]/", "", $obligacion['saldo_total']); ?>"> <?php echo $obligacion['numero_obligacion']; ?></option>
                    <?php endforeach; ?>
                </select>
            </div>
        </div>
