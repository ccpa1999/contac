        ...
        <div class="switch-right-grid">
            <div class="switch-right-grid1">
                <div class="row" style="padding-bottom: 30px;">
                    <div class="row">
                        <div class="col-md-12">
                            <button title="AGREGAR USUARIO" data-parametro="formularioCrearUsuario" data-cartera="" data-identificacion="" 
                                    data-formulario="formularioCreacionUsuario" class="btn btn-primary btn-lg btnFormularioCreacionRegistro">
                        ...
                        <div class="col-md-12 col-sm-12">
                            <div class="input-group in-grp1">
                                ...
                                <input class="form-control busqueda" type="text" 
                                       placeholder="Búsqueda Usuario" autocomplete="off" maxlength="50" 
                                       data-div-resultado="resultadoBusquedaUsuarios"
                                       data-metodo="buscarUsuarios">
                            </div>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="thumbnail">
                                    ...
                                    <div class="caption" style="text-align: center;">
                                        ...
                                        <div class="btn-group" role="group" aria-label="...">
                                            <a class="btn btn-primary reestablecerContraseña" title="Reestablecer Contraseña"
                                               data-id="<?php echo $usuario['id_usuario'] ?>" href="#">
                                                <span class="fa fa-lock"></span> Reestablecer</a>
                                            <a class="btn btn-primary obtenerPermisos" data-toggle="modal"
                                               data-target="#permisosUsuario" data-idenUsuario="<?php echo $usuario['identificacion']; ?>" data-usuario="<?php echo $usuario['id_usuario'] ?>" href="#" role="button">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input value="" class="form-control"
                                           name="telefono_movil" type="text" placeholder="El teléfono celular!">
                                </div>
                            </div>
                        </div>
                    </div>
