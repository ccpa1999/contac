            ...
            <div class="switch-right-grid1" >
                ...
                <div class="row">
                    <div class="col-md-12" style="text-align: center; padding-bottom: 10px;">
                        <button class="btn btn-success" id="btnBorrarCarpeta" data-function><i class="fa fa-trash"></i> Borrar Todo</button>
                    </div>
                </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group" role="group" aria-label="...">
                                                <a class="btn btn-primary" title="Descargar" href="<?php echo $archivo['Ruta']; ?>">
                                                    <span class="fa fa-download"></span>
                                                </a>
                                                <a class="btn btn-danger eliminarArchivo" data-metodo="administracionInformes" data-controlador="administracionController" data-accion="borrarArchivo" data-archivo="<?php echo $archivo['Nombre']; ?>" href="#" title="Eliminar">
