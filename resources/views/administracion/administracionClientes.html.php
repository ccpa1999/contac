                                        ...
                                        <div class="caption" style="text-align: center;">
                                            ...
                                            <div class="btn-group" role="group" aria-label="...">
                                                <a class="btn btn-primary formularioEditarRegistro" data-toggle="modal" 
                                                   data-target="#editarRegistro" data-tipo="editarCliente" data-id="<?php echo $cliente['id_cliente'] ?>" href="#" role="button">
                                                    <span class="glyphicon glyphicon-edit"></span> Editar</a>
                                                <a class="btn btn-primary eliminarRegistro" data-toggle="modal" 
                                                   data-target="#myModal" data-ajax="administracionUsuarios" data-accion="borrarUsuario" data-id="<?php echo $cliente['id_cliente'] ?>" href="#" role="button">
