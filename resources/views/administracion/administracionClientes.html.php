                        ...
                        <div class="col-md-12">
                            <div class="tab-content">
                                <div role="tabpanel" class="tab-pane active" id="asignacion">
                                    <form id="formCargaCliente" data-id="formCargaCliente" class="formCarga" data-tipo="Cliente" enctype="multipart/form-data" action="javascript:void(0);">
                                        <div class="row">
                                            <div class="col-md-6">
                                            ...
                                            <div class="col-md-6 ">
                                                ...
                                                <input type="hidden" name="metodo" value="crearCliente">
                                            </div>
                                        </div>
                                    </form>
                                </div>
                        ...
                        <?php foreach ($clientes as $cliente) : ?>
                            <?php if (isset($cliente['ruta_logo']) && $cliente['ruta_logo'] != '') : ?>
                                <div class="col-sm-6 col-md-4">
                                    <div class="thumbnail">
                                        <img style="display: block; height: 100px; width: 160px" src="../../public/images/<?php echo $cliente['ruta_logo']; ?>" data-holder-rendered="true">
                                        <div class="caption" style="text-align: center;">
                                            <h3><?php echo ucwords($cliente['nombre_cliente']); ?></h3>
                                            <p>
                                            <div class="btn-group" role="group" aria-label="...">
                                                <a class="btn btn-primary formularioEditarRegistro" data-toggle="modal" data-target="#editarRegistro" data-tipo="editarUsuario" data-id="<?php echo $cliente['id_cliente'] ?>" href="#" role="button">
                                                    <span class="glyphicon glyphicon-edit"></span> Editar</a>
                                                <a class="btn btn-primary eliminarRegistro" data-toggle="modal" data-target="#myModal" data-ajax="administracionUsuarios" data-accion="borrarUsuario" data-id="<?php echo $cliente['id_cliente'] ?>" href="#" role="button">
