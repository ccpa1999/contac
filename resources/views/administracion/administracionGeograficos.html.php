        ...
        <div class="col-md-12 switch">
            <div class="switch-right-grid">
                <div class="switch-right-grid1" >
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <form class="form-inline" id="formularioCreacion" action="javascript:void" data-metodo="administracionRoles" data-controlador="administracionController.php">
                                ...
                                <input type="hidden" id="accion" name="accion" value="crearRol">
                            </form>
                        </div>
                    </div>
                    <br />
                                ...
                                <tr>
                                    ...
                                    <th>
                                        <div class="input-group in-grp1">
                                            ...
                                            <input class="form-control" type="text" id ="busquedaRoles" 
                                        ...
                                        <td>
                                            <div class="btn-group" role="group" aria-label="...">
                                                <a class="btn btn-primary formularioEditarRegistro" data-toggle="modal" 
                                                   data-target="#editarRegistro" data-tipo="editarUsuario" data-id="<?= $rol['id_usuario'] ?>" href="#" role="button">
                                                    <span class="glyphicon glyphicon-edit"></span> Editar</a>
                                                <a class="btn btn-primary eliminarRegistro" data-toggle="modal" 
                                                   data-target="#myModal" data-ajax="administracionUsuarios" data-accion="borrarUsuario" data-id="<?= $rol['id_usuario'] ?>" href="#" role="button">
...
<?php elseif ($parametro == 'departamentos'): ?>

<?php elseif ($parametro == 'ciudades'): ?>
