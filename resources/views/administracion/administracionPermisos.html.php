                                    ...
                                    <select class="form-control" required name="menu">
                                        ...
                                        <?php foreach ($menus as $menu): ?>
                                            <option value="<?php echo $menu['idmenu']; ?>">
                                                <?php echo ucwords($menu['menu_nombre']) . " (" . ucwords($menu['menu_tipo']) . ")"; ?>
                                            </option>
                                        <?php endforeach; ?>
                                    </select>
                                </div>
                ...
                <div id="resultadoBusqueda">
                    ...
                    foreach ($permisos as $permiso):
                        ...
                        <tr style="text-align: center;">
                            ...
                            <td><?php echo ucwords($permiso['menu_nombre']); ?></td>
                            <td><?php echo ucwords($permiso['rol']); ?></td>
                            <td><label class="label <?php echo $claseCrear; ?>"><?php echo $estadoCrear; ?></label></td>
                            <td><label class="label <?php echo $claseEditar; ?>"><?php echo $estadoEditar; ?></label></td>
                            <td><label class="label <?php echo $claseEliminar; ?>"><?php echo $estadoEliminar; ?></label></td>
                            <td>
                                <div class="btn-group" role="group" aria-label="...">
                                    <a class="btn btn-primary formularioEditarRegistro" data-toggle="modal" 
                                       data-target="#editarRegistro" data-tipo="editarPermiso" data-id="<?php echo $permiso['idpermisos'] ?>" href="#" role="button">
                                    ...
                                    <a class="btn btn-primary eliminarRegistro" data-metodo="administracionPermisos" data-controlador="administracionController.php"
                                       data-accion="borrarPermiso" data-id="<?php echo $permiso['idpermisos'] ?>" href="#" role="button">
