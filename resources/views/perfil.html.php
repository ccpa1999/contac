<ol class="breadcrumb">
    <li><a href="../../app/controllers/administracionController.php">FIANZA LTDA</a></li>
...
<div class="panel-body panel-body-inputin switch-right-grid">
    ...
    <form id="formularioActualizarInformacionPersonal" action="javascript:void(0);">
                ...
                <div class="col-md-6">
                    <div class="input-group input-icon right in-grp1">
                        ...
                        <input class="form-control1" required type="text" name="nombre"
                               value="<?php echo $usuario[0]['nombre_completo'] ?>">
                    </div>
                </div>
                <div class="col-sm-2 jlkdfj1">
                ...
                <div class="col-md-6">
                    <div class="input-group input-icon right in-grp1">
                        ...
                        <input class="form-control1" required type="text" name="identificacion"
                               value="<?php echo $usuario[0]['identificacion'] ?>">
                    </div>
                </div>
                <div class="col-sm-2 jlkdfj1">
                ...
                <div class="col-md-6">
                    <div class="input-group input-icon right in-grp1">
                        ...
                        <input class="form-control1 fecha" required type="text" name="fecha_nacimiento"
                               value="<?php echo $usuario[0]['fecha_nacimiento'] ?>">
                    </div>
                </div>
                <div class="col-sm-2 jlkdfj1">
        ...
        <input type="hidden" name="perfil" value="<?php echo (isset($usuario[0]['perfil']) ? $usuario[0]['perfil'] : "") ?>">
        <input type="hidden" name="id_usuario" value="<?php echo (isset($usuario[0]['id']) ? $usuario[0]['id'] : "") ?>">
    </form>
</div>
