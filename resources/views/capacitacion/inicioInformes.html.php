...
<input id="sinRealizar" type="hidden" value="<?php echo $pruebas["SinRealizar"] ?>">
<input id="aprobados" type="hidden" value="<?php echo $pruebas["Aprobados"] ?>">
<input id="reprobados" type="hidden" value="<?php echo $pruebas["Reprobados"] ?>">
