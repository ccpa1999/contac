                        ...
                        <table class="table table-bordered" style="text-align: center">
                            ...
                            <tbody>
                                <?php foreach ($capacitacion["Capacitaciones"] as $item): ?>
                                    <tr class="">
                                        <td> <i class="<?=$item['class'] ?>" style="font-size:30px;color:green"</i><input class="" type="checkbox" name="completado<?=$item['id']; ?>" value="<?=$item['id']; ?>" style=" <?php echo ($item['class'] != "") ? "display: none" : "" ; ?>" ></td>
                                        <td> <?=$item["nombre"]; ?></td>  
                                        <?php
                                        $clase = "fa fa-file-o";
                                        switch ($item["tipo"]):
