...
?>
    ...
    <?php if ($_SESSION['estado_pausa'] == 1 && ($_SESSION['rol_actual'] != 1 && $_SESSION['rol_actual'] != 2)) : ?>
        <script>
            iniciarPausa(<?php echo $_SESSION['tiempo_pausa']; ?>, '<?php echo $_SESSION['tipo_pausa']; ?>',
                '<?php echo (isset($_SESSION['label_pausa']) ? $_SESSION['label_pausa'] : ''); ?>');
        </script>
    <?php endif; ?>

    <?php if ($_SESSION['cumpleanios'] == 1) : ?>
        <script>
