                        ...
                        <div id="resultadoBusquedaRoles">
                            ...
                            foreach ($roles as $rol):
                                ...
                                <tr style="text-align: center;">
                                    ...
                                    <td><label class="label <?php echo $clase; ?>"><?php echo $estado; ?></label></td>
                                    <td>
                                        <div class="btn-group" role="group" aria-label="...">
                                            ...
                                            <a class="btn btn-primary eliminarRegistro" data-toggle="modal" data-metodo="administracionRoles"
                                               data-target="#myModal" data-controlador="administracionController" data-accion="borrarRol" data-id="<?php echo $rol['id_rol'] ?>" href="#" role="button">
