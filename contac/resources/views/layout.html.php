...
if ($_SESSION['usuario'] != ''):
    ...
    <body class="sticky-header left-side-collapsed" >
        <section>
            <div class="left-side sticky-left-side">
                <div class="logo">
                    <h1><a href="#">
                            <img src="../../public/images/logo_fianza-01.png" class="img-responsive">
                        </a></h1>
                </div>
                                ...
                                <?php if ($modulo == 'cartera'): ?>
                                    ...
                                    <li class="dropdown">
                                        ...
                                        <ul class="dropdown-menu">
                                            ...
                                            <li>
                                                <a href="#" class="notification_desc pausa" data-pausa="pausas_activas">
                                                    <strong>Pausas Activas</strong>
                                                </a>
                                            </li>
                                            <hr>
                                            <li>
                                                <a href="#" class="notification_desc pausa" data-pausa="Almuerzo">
                                                    <strong>Almuerzo</strong>
                                                </a>
                                            </li>
                                            <hr>
                                            <li>
                                                <a href="#" class="notification_desc pausa" data-pausa="baño">
                                                    <strong>Baño</strong>
                                                </a>
                                            </li>
                                            <li>
    ...
    <!--                                                    <p><?php
                ...
                <div class="alert alert-success alert-dismissible" role="alert" id="alertSuccess" 
                    ...
                    <p><i class="fa fa-check fa-2x"></i></p> <strong>Operación Completada.</strong></div>
                <div class="alert alert-danger alert-dismissible" role="alert" id="alertDanger" 
                    ...
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                    <p><i class="fa fa-times-circle fa-2x"></i></p> <strong>La operación no se ha podido completar.</strong></div>
                ...
                <div id="page-wrapper">
                    ...
                    <!--                        <div id="contenedor_data">
                                                <div class="row">
                                                    <div class="col-md-2 col-md-offset-1 success accionFacturacion" id="" style="cursor: pointer;">
                                                    ...
                                                    <div class="col-md-2 success accionClientes" style="cursor: pointer;">
                                                        <div class="r3_counter_box">
                                                    ...
                                                    <div class="col-md-2 success" style="cursor: pointer;">
                                                        <div class="r3_counter_box">
                                                    ...
                                                    <div class="col-md-2 success" style="cursor: pointer;">
                                                        <div class="r3_counter_box">
                                                            <i class="fa lnr lnr-chart-bars fa-3x"></i>
                                                            <div class="stats">
                                                                <h3>
                                                                    Informes
                                                                </h3>
