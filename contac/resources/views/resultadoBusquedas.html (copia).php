            ...
            <tbody>
                <?php foreach ($resultados as $cliente): ?>
                    <tr style="cursor: pointer" class="editarCliente" data-cliente="<?php echo $cliente['id'] ?>">
                        <td><h3><span class="label label-success"><strong><?php echo strtoupper($cliente['nombre_completo']) ?></strong></span></h3></td>
                        <td><h3><?php echo $cliente['identificacion'] ?></h3></td>
                        <td><h3><?php echo $cliente['direccion'] ?></h3></td>
                        <td><h3><?php echo $cliente['telefono'] ?></h3></td>
                        <td><h3><?php echo $cliente['correo_electronico'] ?></h3></td>
                        <td><h3><?php echo $cliente['placa'] ?></h3></td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
        </table>
...
<?php elseif ($parametro == 'busquedaClientesFacturacion'): ?>
    <div class="table-responsive" style="padding-bottom: 30px; padding-top: 30px;">
        <table class="table table-bordered">
            ...
            <tbody>
                <?php
                file_put_contents("/tmp/datosCliente.txt", print_r($resultados, true));
        ...
        <table class="table">
            ...
            <tbody>
                <?php foreach ($resultados as $servicio): ?>
                    <tr>
                        <td><h3><span class="label label-success"><strong><?php echo mb_strtoupper(utf8_encode($servicio['descripcion_servicio']), 'UTF-8'); ?></strong></span></h3></td>
                        <td><h3><?php echo utf8_encode($servicio['detalle_servicio']) ?></h3></td>
                        <td><h3><?php echo '$' . number_format($servicio['valor']) ?></h3></td>
                        <td><h3><?php echo $servicio['fecha_inicial'] ?></h3></td>
                        <td><h3><?php echo $servicio['fecha_final'] ?></h3></td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
        </table>
                ...
                <div class="caption" style="text-align: center;">
                    ...
                    <div class="btn-group" role="group" aria-label="...">
                        ...
                        <a class="btn btn-primary obtenerPermisos" data-toggle="modal"
                           data-target="#permisosUsuario" data-usuario="<?php echo $usuario['id_usuario'] ?>" href="#" role="button">
                        ...
                        <a class="btn btn-primary eliminarRegistro" data-toggle="modal" data-metodo="administracionUsuarios"
                           data-target="#myModal" data-controlador="administracionController" data-accion="borrarUsuario" data-id="<?php echo $usuario['id_usuario'] ?>" href="#" role="button">
        ...
        <table class="table">
            ...
            <tbody>
                <?php foreach ($resultados as $descuento): ?>
                    <tr>
                        <td><h3><span class="label label-success"><strong><?php echo $descuento['descuento'] ?></strong></span></h3></td>
                        <td><h3><?php echo $descuento['detalle_descuento'] ?></h3></td>
                        <td><h3><?php echo $descuento['valor_descuento'] ?></h3></td>
                        <td><h3><?php echo utf8_encode($descuento['descripcion_servicio']) ?></h3></td>
                        <td><h3><?php echo $descuento['fecha_inicio'] ?></h3></td>
                        <td><h3><?php echo $descuento['fecha_fin'] ?></h3></td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
        </table>
        ...
        <table class="table">
            ...
            <tbody>
                <?php foreach ($resultados as $insumo): ?>
                    <tr>
                        <td><h3><span class="label label-success"><strong><?php echo mb_strtoupper(utf8_encode($insumo['insumo']), 'UTF-8'); ?></strong></span></h3></td>
                        <td><h3><?php echo utf8_encode($insumo['detalle_insumo']) ?></h3></td>
                        <td><h3><?php echo $insumo['medida'] ?></h3></td>
                        <td><h3><?php echo $insumo['cantidad_minima'] ?></h3></td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
        </table>
...
<?php elseif ($parametro == 'busquedaInventarios'): ?>
    <div class="table-responsive">
        <table class="table" style="text-align: center;">
            ...
            <th><center>Usuario Actualizó</center></th>
            ...
            <tbody>
                <?php foreach ($resultados as $inventario): ?>
                    <tr>    
                        <td><h3><span class="label label-success"><strong><?php echo mb_strtoupper(utf8_encode($inventario['insumo']), 'UTF-8'); ?></strong></span></h3></td>
                        <td><h3><?php echo utf8_encode($inventario['cantidad_disponible']) ?></h3></td>
                        <td><h3><?php echo ucwords(utf8_encode($inventario['medida'])) ?></h3></td>
                        <td><h3><?php echo $inventario['nombre_completo'] ?></h3></td>
                        <td><h3><?php echo $inventario['fecha_registro'] ?></h3></td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
...
<?php elseif ($parametro == 'busquedaTiposMantenimiento'): ?>
    <div class="table-responsive">
        <table class="table" style="text-align: center;">
            <thead>
                <tr>
                    <th><center>TIPO DE MANTENIMIENTO</center></th>
            ...
            <tbody>
                <?php foreach ($resultados as $inventario): ?>
                    <tr>    
                        <td><h3><span class="label label-success"><strong><?php echo mb_strtoupper(utf8_encode($inventario['tipo_mantenimiento']), 'UTF-8'); ?></strong></span></h3></td>
                        <td><h3><?php echo utf8_encode($inventario['descripcion']) ?></h3></td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
...
<?php elseif ($parametro == 'busquedaDeudor'): ?>
    <?php $this->layout('layout.html', ['modulo' => 'cartera', 'carteraActual' => $carteraActual,
                                                ...
                                                <tbody>
                                                    <?php foreach ($cliente['obligaciones'] as $obligacion): ?>
                                                        <tr class="obligacionGestion" data-obligacion="<?php echo $obligacion['numero_obligacion']; ?>" style="cursor:pointer;">
                                                            ...
                                                            <td><?php echo $obligacion['fecha_ultimo_pago']; ?></td>
                                                        ...
                                                        <div class="col-md-12">
                                                            ...
                                                            <div id="myTabContent" class="tab-content">
                                                                <div id="telefonos" class="tab-pane fade in active" role="tabpanel" aria-labelledby="home-tab">
                                                                    <button class="btn btn-success btnFormularioCreacionRegistro" data-parametro="telefono"
                                                                    ...
                                                                    <table class="table table-striped table-responsive">
                                                                        ...
                                                                        <tbody>
                                                                            ...
                                                                            foreach ($cliente['telefonos'] as $telefono):
                                                                                $estado = ($telefono['estado'] == 1) ? 'Activo' : 'Inactivo';
                                                                                $clase = ($telefono['estado'] == 1) ? 'success' : 'danger';
                                                                                ?>
                    ...
                    <div class="switch-right-grid">
                        <div class="container-fluid" style="padding-top: 7px;">
                            <div class="row">
                                ...
                                <?php
                                if ($_SESSION['acceso'][$carteraActual - 1]['id_rol'] != '4'):
                                    ?>
                                    <div class="col-xs-3">
                                        <a href="#" class="dropdown-toggle btn btn-success" id="accionAgregarGestion" data-toggle="collapse" data-target="#navbar" aria-expanded="false" aria-controls="navbar">
                ...
                <div class="container-fluid" style="padding-top: 7px;">
                    <div class="row">
                        ...
                        <div class="col-xs-3 col-xs-offset-2">
                            <a href="#" class="siguienteClienteTarea" data-tarea="<?php echo $tarea?>"> <h4>SIGUIENTE <i class="fa fa-arrow-circle-right success fa-1x"></i></h4></a>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
                        <div class="panel panel-default">
                            <div class="row">
                                ...
                                <div class="col-xs-5">
                                    <a href="#"><i class="fa fa-hand-o-left fa-2x success"></i> <i>"Haga clic en "CREDITOS" para desplegar la información de creditos"</i></a> 
                                </div>
                            </div>
                            <div id="collapsCreditos" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingOne">
                                <div class="panel-body">
                        ...
                        <div class="panel-group container-fluid" id="accordion" role="tablist" aria-multiselectable="true">
                            <div class="panel panel-default">
                                <div class="row">
                                    ...
                                    <div class="col-xs-7">
                                        <a href="#"><i class="fa fa-hand-o-left success fa-2x"></i> <i>"Haga clic en "DEMOGRAFICOS" para desplegar la información demográfica"</i></a> 
                                    </div>
                                </div>
                                <div class="row">
                                    <div id="collapsDemograficos" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingOne">
                                                                    ...
                                                                    <tbody>
                                                                        ...
                                                                        foreach ($cliente['direcciones'] as $direccion):
                                                                            ...
                                                                            <tr style="height:30px;">
                                                                                ...
                                                                                <td><div class="btn-group" role="group" aria-label="...">
                                                                                        <a class="btn btn-primary formularioEditarRegistro" data-toggle="modal" 
                                                                                           data-target="#editarRegistro" data-tipo="editarUsuario" data-id="<?php echo $direccion['id_direccion'] ?>" href="#" role="button">
                                                                                            <span class="glyphicon glyphicon-edit"></span></a>
                                                                                        <a class="btn btn-primary eliminarRegistro" data-toggle="modal" 
                                                                                           data-target="#myModal" data-ajax="administracionUsuarios" data-accion="borrarUsuario" data-id="<?php echo $direccion['id_direccion'] ?>" href="#" role="button">
                                                                                            <span class="glyphicon glyphicon-remove"></span></a>
                                                                                    </div></td>
                                                                            </tr>
                                                                        <?php endforeach; ?>
            ...
            <div class="col-md-12 switch">
                <div class="switch-right-grid">
                    <div class="container-fluid" style="padding-top:15px;">
                        ...
                        <div class="row">
                            <div class="col-xs-3">
                                <a href="#"><h5>Nueva Marca Foco</h5></a>
                            </div>
                            <div class="col-xs-3">
                                <label class="label label-success"><?php echo $cliente['obligaciones'][0]['nueva_marca_foco'] ?></label>
                            </div>
                                    ...
                                    <tbody>
                                        <?php foreach ($historial as $historico): ?>
                                            <tr>
                                                ...
                                                <td><?php echo $historico['accion']; ?></td>
                                                <td><?php echo $historico['efecto']; ?></td>
                                                <td><?php echo $historico['contacto']; ?></td>
                                                <td><?php echo $historico['motivo_no_pago']; ?></td>
                                                <td><?php echo $historico['fecha_acuerdo']; ?></td>
                                                <td><?php echo $historico['valor_acuerdo']; ?></td>
                                                <td><?php echo $historico['telefono']; ?></td>
