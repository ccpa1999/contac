<?php if ($parametro == 'telefono'): ?>
    <form class="formularioCreacion" id="formCreacionTelefono" action="javascript:void(0);" data-metodo="buscarDeudorRecarga" data-tipo="cedula" data-dato="<?php echo $datos['identificacion'];?>" data-controlador="carterasController.php">
        <div class="row">
