...
class administracionController {
    ...
    public function administracionClientes($datos)
    {
        ...
        $plantilla = $this->plantillas->render('administracion/administracionClientes.html', ['clientes' => $clientes['clientes'],
            'roles' => $usuarios['roles']]);
        echo $plantilla;
    }
...
//        $menus = $this->claseAdministracion->controlador($datos);
    ...
    public function administracionInformes($datos)
    {
        ...
        $plantilla = $this->plantillas->render('administracion/administracionInformes.html', ['cartera' => $datos['cartera'],
            'archivos' => $archivos]);
        echo $plantilla;
    }
