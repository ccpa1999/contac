...
class modeloAdministracion extends conexion
{
    ...
    private function crearDireccion($datos = array())
    {
        ...
        $query = "INSERT IGNORE INTO direcciones (cedula_deudor, tipo_direccion, ciudad, direccion  ) "
            . "VALUES ('" . $datos['identificacion'] . "','" . utf8_decode($datos['tipo']) . "','" . $datos['ciudad'] . "', "
            . "'" . $datos['direccion'] . "')";
        $return['resultado'] = $this->ejecutar2($query);
    ...
    {
        $resultado = array();
        $query = "UPDATE direcciones SET tipo_direccion = '" . utf8_decode($datos['tipo']) . "', ciudad = '" . $datos['ciudad'] . "',   estado = '" . $datos['estado'] . "'"
    ...
    {
        $resultado = array();
        $query = "UPDATE telefonos SET tipo_telefono = '" . utf8_decode($datos['tipo']) . "', telefono = '" . $datos['telefono'] . "',  estado = '" . $datos['estado'] . "', hora_disponibilidad = '" . $datos['hora'] . "' WHERE id_telefono = '" . $datos['id'] . "'";
        $resultado['respuesta'] = $this->ejecutar2($query);
